...
**Purpose**: A high-level map of the codebase to help the Agent understand
where things are without searching deeply every time.
...
* `system/memory.md`: User preferences and lessons.
