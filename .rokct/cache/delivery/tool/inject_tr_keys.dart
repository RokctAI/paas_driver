...
//
// Usage (from delivery/dart, after `flutter pub get`):
//
...
void main(List<String> args) {
  ...
  // delivery_sdk carries tr_keys BOTH at the top level and inside its
  // app_type flavor block (driver) — on compose the installer injects the
  // top-level map plus the composed flavor's block. Standalone resolves
  // ALL flavors' keys (a harmless superset: tests and analysis cover the
  // whole package, driver folder included).
