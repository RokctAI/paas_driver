...
![Every stop, in order](screenshots/08-driver_route.png)
...
![Proof of every drop](screenshots/09-driver_order_history.png)
...
![Parcels too](screenshots/10-driver_parcels.png)

Documents and packages ride along - sender, receiver and fee on every parcel.

## 11. Pick up a parcel

![Pick up a parcel](screenshots/11-driver_available_parcels.png)

Parcels waiting nearby - add one to your run whenever it fits.

## 12. Parcel trail

![Parcel trail](screenshots/12-driver_parcel_history.png)
...
![Draw where you deliver](screenshots/13-driver_delivery_zone.png)
...
![Money at a glance](screenshots/14-revenue_income.png)

Today, this week or this month - every rand earned, charted day by day.

## 15. A calculator, right where you work

![A calculator, right where you work](screenshots/15-calc_keypad.png)
