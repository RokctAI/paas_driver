abstract class AppConstants {
  ...
  static const String adminPageUrl =
      String.fromEnvironment('ADMIN_URL', defaultValue: baseUrl);
  ...
  static double demoLatitude =
      double.tryParse(const String.fromEnvironment('DEMO_LATITUDE')) ??
          41.304223;
  static double demoLongitude =
      double.tryParse(const String.fromEnvironment('DEMO_LONGITUDE')) ??
          69.2348277;
  ...
  static const String demoSellerLogin =
      String.fromEnvironment('DEMO_DRIVER_LOGIN');
  static const String demoSellerPassword =
      String.fromEnvironment('DEMO_DRIVER_PASSWORD');
